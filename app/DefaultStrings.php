...
class DefaultStrings
{
    public static function get(string $key) {
        $strings = [
            ...
            'occ_consent_modal_description' => __('Hi, this website uses essential cookies to ensure its proper operation and tracking cookies to understand how you interact with it. The latter will be set only after consent.', 'otomaties-cookie-consent'),
            ...
            'occ_settings_modal_cookie_usage_description' => __('We use cookies to ensure the basic functionalities of this website and to enhance your online experience. You can choose for each category to opt-in/out whenever you want.', 'otomaties-cookie-consent'),
            'occ_settings_modal_more_information_title' => __('More information', 'otomaties-cookie-consent'),
            'occ_settings_modal_more_information_description' => sprintf(__('For any queries in relation to our policy on cookies and your choices, please [contact_link].', 'otomaties-cookie-consent'), get_permalink(get_field('occ_settings_modal_contact_page', 'option'))),
